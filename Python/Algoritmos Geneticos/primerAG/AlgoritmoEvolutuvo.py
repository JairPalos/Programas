...
Created on Mon Mar 14 12:06:02 2022
...
class AlgoritmoEvolutivo:
    ...
    def __init__(self, size=100, target="icoic"):#constructor de la clase
    ...
    def inicializa(self):#metodo para empezar el algoritmo evolutivo
        pob = Poblacion(self.target, self.size)#objeto de tipo poblacion se le manda la cadena a encontrar y la longitud
    ...
    def Mejor(self,ind,pob,aptitudes,i):
        print("Mejor: "+self.pob.poblacion[ind].__str__() +" -> " + str(aptitudes[i]))
        
    def evolucion(self,l):#metodo para evolucionar
