...
public class ColaArray // se crea el constructor
{
    ...
    {// se crea la funcion para la cola del arreglo
        ...
        this.FINAL1 = 0;  // se compara numero
        this.COLA = new int[this.MAX+1];// se compara numero
        this.COLA1 = new int[this.MAX+1];// se compara numero;
    }// cierra
    ...
    public boolean IsColaVacia1()// se crea una funcion para  saber si la cola esta vacia
    {
        if(this.FRENTE == this.FINAL1)// si el valor de la cola esta en el incio
        {
            return true;// manda verdadero que si esta vacia
        }
        else// sino
    ...
    public boolean colaNoCopiada()// se crea una funcion para  saber si la cola esta vacia
    {
        if(this.FRENTE != this.FINAL)// si el valor de la cola esta en el incio
        {
            return true;// manda verdadero que si esta vacia
    ...
    public void MostrarCola()// se crea una funciom para MOSTRAR la cola
    {
        ...
        else
        {
            ...
            JOptionPane.showMessageDialog(null,"TOTAL ES : "+this.FINAL+"\n"+"LOS DATOS DE LA COLA A SON : \n"+MOSTRAR,"MOSTRAR DATOS",JOptionPane.INFORMATION_MESSAGE);
        }// muestra el valores de la cola
    }

    public void MostrarCola2()// se crea una funciom para MOSTRAR la cola
    {
         if(this.IsColaVacia1())// si el valor de cola vacia
          {
            JOptionPane.showMessageDialog(null,"COLA ESTA VACIA","MOSTRAR DATOS",JOptionPane.WARNING_MESSAGE);
          }// si el verdadero muestra que la cola esta vacia
        else {
            String MOSTRAR = "";// crea un string para pprder mostar
            int [] copia = CopiarCola();

            for(int i=FRENTE+1;i<=FINAL1;i++)// recorre el arreglo
            {
                MOSTRAR = MOSTRAR + copia[i] +"\n";// imprime el valor de la cola
            }

            JOptionPane.showMessageDialog(null,"TOTAL ES : "+this.FINAL1+"\n"+"LA COLA B  ES: \n"+MOSTRAR,"MOSTRAR DATOS",JOptionPane.INFORMATION_MESSAGE);

        }// muestra el valores de la cola
    }

    public void copy(){
        JOptionPane.showMessageDialog(null,"Se HA MOVIDO LA COLA A -COLA B","MOSTRAR DATOS",JOptionPane.WARNING_MESSAGE);
        VaciarCola();
    }
    public int  [] CopiarCola()// se crea una funciom para MOSTRAR la cola
    {
        {
            for(int i=FRENTE+1;i<=FINAL1;i++)// recorre el arreglo
            {
